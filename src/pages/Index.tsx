            ...
            <div className="space-y-8 animate-fade-in">
              <div className="space-y-6">
                <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center border border-primary/30 animate-circle-glow">
                  <span className="font-serif text-primary animate-number-pop my-0 text-5xl font-normal">1</span>
                </div>
                <div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 animate-fade-in order-1 lg:order-2">
              <div className="space-y-6">
                <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center border border-primary/30 animate-circle-glow">
                  <span className="font-serif text-primary animate-number-pop my-0 text-5xl font-normal" style={{animationDelay: '0.2s'}}>2</span>
                </div>
                <div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 animate-fade-in">
              <div className="space-y-6">
                <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center border border-primary/30 animate-circle-glow">
                  <span className="font-serif text-primary animate-number-pop my-0 text-5xl font-normal" style={{animationDelay: '0.4s'}}>3</span>
                </div>
                <div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 animate-fade-in order-1 lg:order-2">
              <div className="space-y-6">
                <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center border border-primary/30 animate-circle-glow">
                  <span className="font-serif text-primary animate-number-pop my-0 text-5xl font-normal" style={{animationDelay: '0.6s'}}>4</span>
                </div>
                <div>
